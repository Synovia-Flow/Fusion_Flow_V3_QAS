...
- `GET /api/tss/readiness` or `?client_code=PLE` - reports login/connection/file-rule state and whether a real PRS consignment can run the ENS-before-submit dry-run.`r`n- `GET /api/tss/route-plan?client_code=PLE`
